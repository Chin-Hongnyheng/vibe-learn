...
export function LearningPage() {
  ...
  const targetIndex = allLessonsWithModule.findIndex(
    (item) => item.lesson.slug === lessonQuery || item.lesson.id === lessonQuery
  )
        ...
        <main className="flex-1 px-4 py-8 sm:px-8 lg:px-12">
          ...
          <div className="mt-4">
            ...
            {activeLesson.notesText && (
              <p className="mt-3 max-w-3xl text-sm leading-relaxed text-neutral-600 sm:text-base dark:text-neutral-300 line-clamp-2">
          ...
          <div className="mt-8 overflow-hidden rounded-2xl border border-neutral-200/80 bg-black shadow-lg dark:border-neutral-800 aspect-video w-full">
          ...
          <div className="mt-4 flex flex-wrap items-center justify-between gap-4 border-b border-neutral-200 pb-6 dark:border-neutral-800">
            <button
              type="button"
              onClick={() => toggleLessonComplete(activeLesson.id)}
              className={cn(
                "inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold transition shadow-xs",
            ...
            <div className="flex items-center gap-3">
              {currentIndex > 0 && (
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl border border-neutral-200 bg-white px-4 py-2 text-sm font-semibold text-neutral-700 transition hover:bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-200"
                >
                  <ArrowLeft className="size-4" />
                  Previous
                </button>
          ...
          {activeTab === "content" ? (
            <div className="mt-8 space-y-8">
              ...
              {activeLesson.notesText && (
                <div>
                  ...
                  <div className="mt-3 space-y-3 text-sm leading-relaxed text-neutral-600 sm:text-base dark:text-neutral-300 whitespace-pre-line">
                    {activeLesson.notesText}
                  </div>
                </div>
              )}
              ...
              {/* Pro Tip Callout Box */}
              {activeLesson.proTip && (
                <div className="rounded-2xl border border-emerald-200/80 bg-emerald-50/50 p-6 dark:border-emerald-900/60 dark:bg-emerald-950/20">
                  <div className="flex items-center gap-2 text-emerald-700 dark:text-emerald-300">
                    <Sparkles className="size-5" />
                    <h4 className="font-sans text-base font-bold">Pro Tip</h4>
                  </div>
                  <p className="mt-2 text-sm leading-relaxed text-emerald-900 sm:text-base dark:text-emerald-200">
                    {activeLesson.proTip}
                  </p>
                </div>
              )}
                ...
                <div>
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    {activeLesson.resources.map((res, rIdx) => (
                      ...
                      >
                        <div>
                          <h4 className="text-sm font-semibold text-neutral-900 group-hover:text-emerald-600 dark:text-white dark:group-hover:text-emerald-400">
                            {res.title}
                          </h4>
                          {res.description && (
            ...
            <div className="mt-8 space-y-4">
              ...
              <textarea
                ...
                className="w-full min-h-[300px] rounded-2xl border border-neutral-200 bg-white p-4 font-mono text-sm leading-relaxed text-neutral-900 shadow-xs transition focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 dark:border-neutral-800 dark:bg-neutral-900 dark:text-white"
              />

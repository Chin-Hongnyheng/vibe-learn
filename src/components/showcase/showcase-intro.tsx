...
export function ShowcaseIntro({
  ...
  return (
    <div className={cn("flex flex-col justify-center", className)}>
      ...
      <h2 className="mt-3 text-3xl font-extrabold tracking-tight text-neutral-900 sm:text-4xl sm:leading-tight dark:text-white">
        {title}
      </h2>
      <p className="mt-4 max-w-sm text-sm leading-relaxed text-neutral-500 sm:text-base dark:text-neutral-400">
        {description}
      </p>
    </div>
  )
